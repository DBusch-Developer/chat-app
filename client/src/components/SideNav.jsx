...
const SideNav = ({ setIsLoggedIn, users }) => {
    ...
    <>
        ...
        <div className="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-800 dark:border-gray-700 ">
          <div className="flex flex-col items-center">
            <img
              ...
              src={`${userData.avatar}`}
            />
            <p className="mt-3 text-2xl font-bold">{userData.username}</p>
            ...
            <div className="mt-5">
              <button
                ...
                type="button"
                className="flex flex-row items-center justify-center w-56 border-2 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2 cursor-pointer hover:bg-gray-100"
              >
                <svg
          ...
          <ul className="pt-5 mt-5 space-y-3 border-t border-gray-200 dark:border-gray-700">
            <li>
              <Link
                to="/dashboard"
                className={`${
                  location.pathname === "/dashboard" ? "bg-gray-100" : ""
                } flex p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group`}
              >
                <svg
                  className="h-5"
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <li>
              <Link
                to="/chat"
                className={`${
                  location.pathname === "/chat" ? "bg-gray-100" : ""
                } flex p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group`}
              >
                <svg
                  className="h-5"
                ...
                <span className="ml-7">CHAT</span>
                {/* <span className="ml-5 flex items-center justify-center w-6 h-6 text-sm text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">
                  {users.length}
                </span> */}
              </Link>
            </li>
              ...
              <Link
                ...
                className={`${
                  location.pathname === "/contacts"
                    ? "bg-gray-100 flex p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group"
                    : ""
                }flex p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-100 dark:hover:bg-gray-700 dark:text-white group`}
              >
                <svg
                ...
                <span className="ml-7">CONTACT</span>
              </Link>
            </li>
            <li>
              <Link
      ...
      {showModal && (
        <div
          id="crud-modal"
          tabIndex="-1"
          className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 m-auto w-full md:inset-0 h-[calc(100%-1rem)] max-h-full"
        >
