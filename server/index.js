...
import loggedInUserRouter from "./loggedInUsers/index.js";
...
app.use("/loggedinusers", loggedInUserRouter)
...
//   }
//   console.log("user showed here", user)
...
//   socket.on("Welcome messaged", (msg) => {
